            ...
            <div class="row justify-content-between">
                <div class="col-sm-6 col-md-6 col-lg-3">
                    <div class="single-footer-widget">
                        <h4>Contact Info</h4>
                        <p>41361 Perumahan Resinda Blok C 11 NO. 8 , Resinda
                            Karawang Barat</p>
                            <br>
                        <ul>
                            <li><a href="#"><i class="ti-mobile"></i> +62 - 858 9876 1209</a></li>
                            <li><a href="#"><i class="ti-email"></i> siswaits@its.ac.id</a></li>
                            <li><a href="#"><i class="ti-world"></i> wasisits.com</a></li>
                        </ul>
      ...
      <!--          <div class="col-sm-6 col-md-6 col-lg-3">
                ...
                <div class="col-sm-6 col-md-6 col-lg-3">
                    <div class="single-footer-widget footer_2">
                        <h4>Newsletter</h4>
                        <p>Stay updated with our latest info see heaven so said place fruit.
                        </p>
